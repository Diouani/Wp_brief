...
$size = $align = $el_class = $link = $position = $css_animation = $css = '';
...
$desc = riven_shortcode_js_remove_wpautop($content, true);
?>
<?php if($position == 'left') :?>
	<div class="service-icon-left service-desc">
		<div
			class="services vc_icon_element vc_icon_element-outer<?php echo strlen( $css_class ) > 0 ? ' ' . trim( esc_attr( $css_class ) ) : ''; ?> vc_icon_element-align-<?php echo esc_attr( $align ); ?><?php if ( $has_style ) { echo ' vc_icon_element-have-style'; } ?>">
