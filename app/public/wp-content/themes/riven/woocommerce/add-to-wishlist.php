...
<div class="add-to-wishlist yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr($product_id) ?>">
	<?php if( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
	    ...
	    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
	        <a data-toggle="tooltip" title="wishlist" href="<?php echo esc_url( $wishlist_url )?>" >
	...
	<?php else: ?>
		<a data-toggle="tooltip" title="wishlist" href="<?php echo esc_url( add_query_arg( array( 'wishlist_notice' => 'true', 'add_to_wishlist' => $product_id ), get_permalink( wc_get_page_id( 'myaccount' ) ) ) )?>" rel="nofollow" class="<?php echo str_replace( 'add_to_wishlist', '', $link_classes ) ?>" >
