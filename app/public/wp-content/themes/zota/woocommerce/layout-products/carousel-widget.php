    ...
    <?php while ( $loop->have_posts() ): $loop->the_post(); ?>
		...
		<div class="item">
			<div <?php wc_product_class( $classes, $loop->get_id() ); ?>>
	            <?php wc_get_template( 'item-product/skins/'.$skin.'/vertical.php', array('show_des' => $show_des, 'countdown' => $countdown, 'countdown_title' => $countdown_title, 'flash_sales' => $flash_sales, 'end_date' => $end_date ) ); ?>
	        </div>
