		...
		<div class="col-xl-8 tb-cart-form">
							...
							<div class="product-remove">
								<?php
									...
									echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
										...
										esc_attr__( 'Remove this item', 'zota' ),
										esc_attr( $product_id ),
			...
			<div class="cart-bottom clearfix actions">
				...
				<div class="update-cart pull-right">
					<input type="submit" class="btn btn-default update" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'zota' ); ?>" />
				</div>
			...
			<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon">
							...
							<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" placeholder="<?php esc_attr_e('Enter coupon code here...', 'zota'); ?>" /><input type="submit" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'zota' ); ?>" /></div>
