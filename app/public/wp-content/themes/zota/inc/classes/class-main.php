...
class zota_setup_theme {
    function __construct() {
        ...
        add_action('wp', 'zota_get_display_header_builder');
    ...
    public function load_admin_login_styles() {
        wp_enqueue_style( 'zota-login-admin', ZOTA_STYLES . '/admin/login-admin.css', false, '1.0.0' );
    }
 
    public function load_admin_styles() {
        wp_enqueue_style( 'material-design-iconic-font', ZOTA_STYLES . '/material-design-iconic-font.css', false, '2.2.0' ); 
        wp_enqueue_style( 'zota-custom-admin', ZOTA_STYLES . '/admin/custom-admin.css', false, '1.0.0' );

        $suffix = (zota_tbay_get_config('minified_js', false)) ? '.min' : ZOTA_MIN_JS;
        wp_enqueue_script( 'zota-admin', ZOTA_SCRIPTS . '/admin/admin' . $suffix . '.js', array( ), ZOTA_THEME_VERSION, true );
    }
