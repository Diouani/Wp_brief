...
class Tbay_Widget_Popup_Newsletter extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            ...
            array( 'description' => esc_html__( 'Show Popup Newsletter', 'zota' ), )
        );
    ...
    public function scripts() {
        ...
        wp_enqueue_script( 'zota-admin', ZOTA_SCRIPTS . '/admin/admin' . $suffix . '.js', array( 'jquery' ), TBAY_ELEMENTOR_VERSION, true );
    }
            ...
            ?>
                ...
                <input class="checkbox" type="checkbox" <?php checked( $checked, 1 ); ?> id="<?php echo esc_attr( $key ); ?>"
                    ...
                    <label for="<?php echo esc_attr($this->get_field_name('socials') ); ?>[<?php echo esc_attr( $key ); ?>][status]">
                        <?php esc_html_e('Show ','zota').esc_html( $value ); ?>
                    </label>
