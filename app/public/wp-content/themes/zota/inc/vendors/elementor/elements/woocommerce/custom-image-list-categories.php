...
if ( ! defined( 'ABSPATH' ) || function_exists('Zota_Elementor_Custom_Image_List_Categories') ) {
...
$widgets_manager->register_widget_type(new Zota_Elementor_Custom_Image_List_Categories());
