...
if ( ! defined( 'ABSPATH' ) || function_exists('Zota_Elementor_Instagram_Feed') ) {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => sprintf(__('Number of Photos <a href="%s" target="_blank">here</a>', 'zota'), admin_url('?page=sb-instagram-feed&tab=customize#layout')),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => false,
                'type' => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(__('Image Resolution <a href="%s" target="_blank">here</a>', 'zota'), admin_url('?page=sb-instagram-feed&tab=customize#photos')),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => false,
                'type' => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(__('Header <a href="%s" target="_blank">here</a>', 'zota'), admin_url('?page=sb-instagram-feed&tab=customize#headeroptions')),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => sprintf(__('Load More Button <a href="%s" target="_blank">here</a> </br> Only show on layout grid', 'zota'), admin_url('?page=sb-instagram-feed&tab=customize#loadmore')),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => false,
                'type' => Controls_Manager::RAW_HTML,
                'raw'             => sprintf(__('Follow <a href="%s" target="_blank">here</a>', 'zota'), admin_url('?page=sb-instagram-feed&tab=customize#follow')),
            ]
        );
...
$widgets_manager->register_widget_type(new Zota_Elementor_Instagram_Feed());
