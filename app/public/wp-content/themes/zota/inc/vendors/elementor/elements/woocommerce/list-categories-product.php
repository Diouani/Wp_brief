...
if ( ! defined( 'ABSPATH' ) || function_exists('Zota_Elementor_List_Categories_Product') ) {
...
$widgets_manager->register_widget_type(new Zota_Elementor_List_Categories_Product());
