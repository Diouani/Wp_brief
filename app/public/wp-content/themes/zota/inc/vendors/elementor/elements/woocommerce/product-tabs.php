...
if ( ! defined( 'ABSPATH' ) || function_exists('Zota_Elementor_Product_Tabs') ) {
...
class Zota_Elementor_Product_Tabs extends  Zota_Elementor_Carousel_Base{
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of products ( -1 = all )', 'zota'),
...
$widgets_manager->register_widget_type(new Zota_Elementor_Product_Tabs());
