...
if ( ! defined( 'ABSPATH' ) || function_exists('Zota_Elementor_Product_Recently_Viewed') ) {
...
$widgets_manager->register_widget_type(new Zota_Elementor_Product_Recently_Viewed());