...
if( ! function_exists( 'zota_wcvendors_vendor_registration_checkbox' ) ) {
	function zota_wcvendors_vendor_registration_checkbox( $become_a_vendor_label ) {
		$output = '<span>'. $become_a_vendor_label .'<span>';

		return $output;
	}
	add_filter('wcvendors_vendor_registration_checkbox', 'zota_wcvendors_vendor_registration_checkbox', 10, 1);
}
