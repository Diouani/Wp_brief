...
if( ! function_exists( 'zota_tbay_wfcm_change_become_vendor_register_form' ) ) {
    function zota_tbay_wfcm_change_become_vendor_register_form() {
        global $WCFMmp;
    ...
    add_action('woocommerce_before_customer_login_form', 'zota_tbay_wfcm_change_become_vendor_register_form', 10);
}
