...
$main_color_skin 	= '.has-before:hover,button.btn-close:hover,.tbay-element-product-categories-tabs .tabs-list > li > a.active,.tbay-element-product-categories-tabs .tabs-list > li > a:hover,.tbay-element-product-tabs .tabs-list > li > a.active,.tbay-element-product-tabs .tabs-list > li > a:hover , .flash-sales-date .times > div > span , .flash-sales-date .times > span,.product-block.inner .group-add-to-cart a,.product-block.inner .group-add-to-cart .add_to_cart_button.added + a ';  
$main_bg_skin 		= '.btn-theme,.owl-carousel > .slick-arrow:hover,.owl-carousel > .slick-arrow:focus , .elementor-widget-tbay-nav-menu .tbay-horizontal .navbar-nav > li > a:after,.tbay-element-product-categories-tabs .tabs-list > li > a:after,.tbay-element-product-tabs .tabs-list > li > a:after,.product-block.inner .group-add-to-cart a:hover,.product-block.inner .group-add-to-cart a:focus,.has-before:hover:after , .title-widget-2::after,.product-block.inner .group-buttons > div > a:hover,.product-block.inner .group-buttons > div.button-wishlist > div > div:hover,.product-block.inner .group-buttons > div a.added,.product-block.inner .group-buttons > div.button-wishlist > div .yith-wcwl-wishlistexistsbrowse,.product-block.inner .group-buttons > div.button-wishlist > div .yith-wcwl-wishlistaddedbrowse';
$main_border_skin 	= '';
