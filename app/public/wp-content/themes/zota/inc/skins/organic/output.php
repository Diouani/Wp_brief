...
$main_color_skin 	= '.has-before:hover,button.btn-close:hover , .post .entry-header .readmore,.owl-carousel > .slick-arrow:hover i,.owl-carousel > .slick-arrow:focus i,.slider > .slick-arrow:hover i,.slider > .slick-arrow:focus i , .top-flash-sale-wrapper .flash-sales-date .times,.flash-sales-date .times > span ';  
$main_bg_skin 		= '.btn-theme,.has-before:hover:after , .title-widget-2::after,.post .entry-header .readmore:after,.product-block.inner .group-buttons > div > a:hover,.product-block.inner .group-buttons > div.button-wishlist > div > div:hover,.product-block.inner .group-buttons > div a.added,.product-block.inner .group-buttons > div.button-wishlist > div .yith-wcwl-wishlistexistsbrowse,.product-block.inner .group-buttons > div.button-wishlist > div .yith-wcwl-wishlistaddedbrowse,.product-block.inner .group-add-to-cart a ';
$main_border_skin 	= '';
