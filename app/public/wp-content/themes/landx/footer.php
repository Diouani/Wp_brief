...
if( function_exists('ot_get_option') ){
	...
	$copyright_text =  ot_get_option( 'copyright_text', '&copy;2017 LandX Template LLC.' );
...
<div class="container">
	...
	<ul class="social-icons">
		<?php foreach ($social_array as $key => $value) {
			echo '<li><a target="_blank" href="'.$value['link'].'" title="'.$value['title'].'"><span class="'.$value['icon'].'"></span></a></li>';
		} ?>
	</ul>
	<?php endif; ?>
