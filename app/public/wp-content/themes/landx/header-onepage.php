...
<?php 
$class = array();
$class[] = get_post_meta( get_the_ID(), 'bg_style', true );
$class[] = $onepage_header_style = get_post_meta( get_the_ID(), 'onepage_header_style', true ); 
$class = array_filter($class);
?>
<header id="home" class="<?php echo implode(' ', $class); ?>">
	...
	<?php
		...
		$slider_class = array_filter($slider_class);
		?>
		<div class="slider-wrapper">	
		<?php	echo do_shortcode($custom_header_slider); ?>
		</div>
		<?php } ?>
    <div id="<?php echo get_the_slug(get_the_ID()); ?>" class="<?php echo implode(' ', $slider_class); ?>">
    	...
    	<?php if($onepage_header_style == 'video'): ?>
	    	<video autoplay poster="<?php echo esc_url(get_post_meta( get_the_ID(), 'background', true )) ?>" id="bgvid" loop>
				...
				<source src="<?php echo esc_url(get_post_meta( get_the_ID(), 'mov_video_url', true )) ?>" type="video/mov">
			</video>
		<?php endif; ?>
		...
		<div class="color-overlay">	
			...
			<div class="container">
				<div class="intro-section">
					<?php
						$container_class = $form_container_class = array();
						...
						$form_container_class = array_filter($form_container_class);
					?>
					<div class="row">
						...
						<div class="<?php echo implode(' ', $form_container_class); ?>">
