          ...
          array(
            ...
            'pages'               => array( 
              ...
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'landx' ) ),

                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'landx' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'landx' ) ),

                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'landx' ) ),

                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'landx' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'landx' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      ...
      array( 
        ...
        'page_title'      => __( 'OptionTree', 'landx' ),

        'menu_title'      => __( 'OptionTree', 'landx' ),
      ...
      array(
        ...
        'page_title'      => __( 'Settings', 'landx' ),

        'menu_title'      => __( 'Settings', 'landx' ),
        ...
        'updated_message' => __( 'Theme Options updated.', 'landx' ),

        'reset_message'   => __( 'Theme Options reset.', 'landx' ),

        'button_text'     => __( 'Save Settings', 'landx' ),
        ...
        'sections'        => array(
          ...
          array(
            ...
            'title'       => __( 'Theme Options UI', 'landx' )
        ...
        'settings'        => array(
          ...
          array(
            ...
            'label'       => __( 'Theme Options UI Builder', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'Settings PHP File', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'Layout Management', 'landx' ),
      ...
      array(
        ...
        'page_title'      => __( 'Documentation', 'landx' ),

        'menu_title'      => __( 'Documentation', 'landx' ),
        ...
        'sections'        => array(
          ...
          array(
            ...
            'title'       => __( 'Creating Options', 'landx' )
          ...
          array(
            ...
            'title'       => __( 'Function References', 'landx' )
          ...
          array(
            ...
            'title'       => __( 'Layouts Overview', 'landx' )
        ...
        'settings'        => array(
          ...
          array(
            ...
            'label'       => __( 'Overview of available Theme Option fields.', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'Option types in alphabetical order & hooks to filter them.', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'Function Reference:ot_get_option()', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'Function Reference:get_option_tree()', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'Code examples for front-end development.', 'landx' ),
          ...
          array(
            ...
            'label'       => __( 'What\'s a layout anyhow?', 'landx' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'landx', 'invalid_border_width', sprintf( __( 'The %s input field for %s only allows numeric values.', 'landx' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'landx', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'landx' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'landx', 'invalid_dimension_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'landx' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'landx', 'invalid_spacing_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'landx' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'landx' ) ),

      'remove_media_text'     => __( 'Remove Media', 'landx' ),

      'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'landx' ),

      'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'landx' ),

      'remove_agree'          => __( 'Are you sure you want to remove this?', 'landx' ),

      'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'landx' ),

      'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'landx' ),

      'delete'                => __( 'Delete Gallery', 'landx' ), 

      'edit'                  => __( 'Edit Gallery', 'landx' ), 

      'create'                => __( 'Create Gallery', 'landx' ), 

      'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'landx' ),

      'date_current'          => __( 'Today', 'landx' ),

      'date_time_current'     => __( 'Now', 'landx' ),

      'date_close'            => __( 'Close', 'landx' ),

      'replace'               => __( 'Featured Image', 'landx' ),
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
  ...
  function ot_get_media_post_ID() {
    ...
    if ( $post_ID === false || empty( $post_ID ) ) {
      ...
      $post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'landx' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'landx', array(

      'labels'              => array( 'name' => __( 'Option Tree', 'landx' ) ),
        ...
        $settings = array(
          ...
          'settings' => array(
            ...
            array(
              ...
              'label'     => __( 'Sample Text Field Label', 'landx' ),

              'desc'      => __( 'Description for the sample text field.', 'landx' ),
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'landx' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'landx' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'landx' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'landx' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'landx' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'landx' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'landx' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'landx' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'landx' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'landx' ) . '</p></div>';
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'landx' ) . '</p></div>';
      ...
      return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'landx' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      ...
      'background'                => __('Background', 'landx'),

      'border'                    => __('Border', 'landx'),

      'box-shadow'                => __('Box Shadow', 'landx'),

      'category-checkbox'         => __('Category Checkbox', 'landx'),

      'category-select'           => __('Category Select', 'landx'),

      'checkbox'                  => __('Checkbox', 'landx'),

      'colorpicker'               => __('Colorpicker', 'landx'),

      'colorpicker-opacity'       => __('Colorpicker Opacity', 'landx'),

      'css'                       => __('CSS', 'landx'),

      'custom-post-type-checkbox' => __('Custom Post Type Checkbox', 'landx'),

      'custom-post-type-select'   => __('Custom Post Type Select', 'landx'),

      'date-picker'               => __('Date Picker', 'landx'),

      'date-time-picker'          => __('Date Time Picker', 'landx'),

      'dimension'                 => __('Dimension', 'landx'),

      'gallery'                   => __('Gallery', 'landx'),

      'google-fonts'              => __('Google Fonts', 'landx'),

      'javascript'                => __('JavaScript', 'landx'),

      'link-color'                => __('Link Color', 'landx'),

      'list-item'                 => __('List Item', 'landx'),

      'measurement'               => __('Measurement', 'landx'),

      'numeric-slider'            => __('Numeric Slider', 'landx'),

      'on-off'                    => __('On/Off', 'landx'),

      'page-checkbox'             => __('Page Checkbox', 'landx'),

      'page-select'               => __('Page Select', 'landx'),

      'post-checkbox'             => __('Post Checkbox', 'landx'),

      'post-select'               => __('Post Select', 'landx'),

      'radio'                     => __('Radio', 'landx'),

      'radio-image'               => __('Radio Image', 'landx'),

      'select'                    => __('Select', 'landx'),

      'sidebar-select'            => __('Sidebar Select',  'landx'),

      'slider'                    => __('Slider', 'landx'),

      'social-links'              => __('Social Links', 'landx'),

      'spacing'                   => __('Spacing', 'landx'),

      'tab'                       => __('Tab', 'landx'),

      'tag-checkbox'              => __('Tag Checkbox', 'landx'),

      'tag-select'                => __('Tag Select', 'landx'),

      'taxonomy-checkbox'         => __('Taxonomy Checkbox', 'landx'),

      'taxonomy-select'           => __('Taxonomy Select', 'landx'),

      'text'                      => __('Text', 'landx'),

      'textarea'                  => __('Textarea', 'landx'),

      'textarea-simple'           => __('Textarea Simple', 'landx'),

      'textblock'                 => __('Textblock', 'landx'),

      'textblock-titled'          => __('Textblock Titled', 'landx'),

      'typography'                => __('Typography', 'landx'),

      'upload'                    => __('Upload', 'landx')
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      ...
      array(
        ...
        'label'   => __( 'Full Width (no sidebar)', 'landx' ),
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      ...
      array(
        ...
        'desc'      => __( 'Enter the name of the social website.', 'landx' ),
      ...
      array(
        ...
        'desc'      => __( 'Enter the text shown in the title attribute of the link.', 'landx' ),
      ...
      array(
        ...
        'desc'      => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'landx' ), '<code>http://</code>' ),
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        ...
        add_settings_error( 'landx', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'landx' ), '<code>' . $filepath . '</code>' ), 'error' );
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        ...
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'landx' ) . '">

          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'landx' ) . '

        </a>

        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'landx' ) . '">

          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'landx' ) . '
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text">
            ...
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text">
            ...
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'landx' ) . '</div>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-select wide-desc">
            ...
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textarea wide-desc">
            ...
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'landx' ) . '</div>
            ...
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'landx' ) . '</a>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'landx' ) . '</div>
            ...
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'landx' ) . '</a>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-select wide-desc">
            ...
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'landx' ) . '</div>

            <div class="format-setting-inner">

              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">

                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'landx' ) . '</option>

                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'landx' ) . '</option>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting-label">
            ...
            <h5>' . __( 'Image Source (Radio Image only)', 'landx' ) . '</h5>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text no-desc">
            ...
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'landx' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textarea no-desc">
            ...
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'landx' ) . '</div>
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'landx' ) ) . '</div>

      <div class="button-section">

        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'landx' ) . '">

          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'landx' ) . '
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'landx' ) . '">' . __( 'New Layout', 'landx' ) . '</button>';
  ...
  if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_query_args = array(
      ...
      'sort'   => $ot_google_fonts_sort
        ...
        $ot_google_fonts_data = json_decode( trim( landx_get_google_fonts_array() ), true );
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => __( 'Source Name (ex. author, singer, actor)', 'landx' ),
      ...
      array(
        ...
        'desc'    => __( 'Source Title (ex. book, song, movie)', 'landx' ),
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'landx' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'landx' ) .'</a>', '<code>[video]</code>' ),
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'landx' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'landx' ) .'</a>', '<code>[audio]</code>' ),
