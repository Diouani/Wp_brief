...
function landx_title_tag_std(){
    return array(                 
          array(
            'value'       => 'h2',
            'label'       => esc_attr__( 'H1', 'landx' ),
          ),
          array(
            'value'       => 'h2',
            'label'       => esc_attr__( 'H2', 'landx' ),
          ),
          array(
            'value'       => 'h3',
            'label'       => esc_attr__( 'H3', 'landx' ),
          ),
          array(
            'value'       => 'h4',
            'label'       => esc_attr__( 'H4', 'landx' ),
          ),
          array(
            'value'       => 'h5',
            'label'       => esc_attr__( 'H5', 'landx' ),
          ),
          array(
            'value'       => 'h6',
            'label'       => esc_attr__( 'H6', 'landx' ),
          )
    );
}

/*Single post title tag size */

function landx_title_tag_size_std(){
    return array(                 
          array(
               'value'       => 'single-title',
               'label'       => esc_attr__( 'Default', 'landx' ),
              ),
              array(
                'value'       => 'xl',
                'label'       => esc_attr__( 'Extra large', 'landx' ),
              ),
              array(
                'value'       => 'lg',
                'label'       => esc_attr__( 'Large', 'landx' ),
              ),
              array(
                'value'       => 'md',
                'label'       => esc_attr__( 'Medium', 'landx' ),
              ),
              array(
                'value'       => 'sm',
                'label'       => esc_attr__( 'Small', 'landx' ),
              ),
              array(
                'value'       => 'xs',
                'label'       => esc_attr__( 'Extra small', 'landx' ),
              )
    );
}
...
function single_post_title_tag(){
    $tag = ot_get_option('single_post_title_tag', 'h2');
    $tag = ( $tag != '' )? $tag : 'h2';
    return esc_attr($tag);
}
function landx_single_post_title_before(){
    $tag = single_post_title_tag();
    $tag_size = ot_get_option('single_post_title_tag_size', 'single-title'); 
    $tag_size = ($tag_size != 'single-title')?  $tag.'-'.$tag_size : $tag_size;

    return sprintf('<%s class="%s">', $tag, $tag_size );
}
function landx_single_post_title_after(){
    $tag = single_post_title_tag();
