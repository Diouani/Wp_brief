<?php
add_action( 'init', 'landx_google_fonts_init' );
function landx_google_fonts_init(){
    $ot_google_fonts_cache_key = 'landxperchdevelopment';
...
function landx_get_google_fonts_array(){
$landx_fonts ='{
