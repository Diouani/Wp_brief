...
class Landx_Vc_Font_Container {
	...
	public function _vc_size_class_options(){
	    $allowed_size = array(
	        __('Default', 'landx') => '',
	        __('Huge', 'landx') => 'huge',
	        __('Extra large', 'landx') => 'xl',
	        __('Large', 'landx') => 'lg',
	        __('Medium', 'landx') => 'md',
	        __('Small', 'landx') => 'sm',
	        __('Extra small', 'landx') => 'xs',
	    );
 ...
 */
function landx_get_vc_typography_value( $value ){
	$fields = array();
	$values = '';
	$font_container = new landx_Vc_Font_Container();	
