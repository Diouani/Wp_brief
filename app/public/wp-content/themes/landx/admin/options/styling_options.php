...
function landx_styling_options( $options = array() ){
	$options = array(
        ...
        'action'      => array(
                array(
                'selector' => '.woocommerce span.onsale, .woocommerce-page span.onsale, .woocommerce ul.products li.product .onsale, .colored-line, .color-bg, .standard-button, .standard-button:hover, .feature-list-1 li  .icon-container, .feature-list-1  .icon-container,
                .feature-list li .icon-container, .feature-list-2 li .icon-container, .screenshots .owl-theme .owl-controls .owl-page span,
                .perch-social-icon, .search-submit, .newsletter-submit, .widget_newsletterwidget:before, .btn-primary, .btn-primary:hover',
                ...
                array(
					...
					.intro-section .wpcf7 .wpcf7-form-control.input-box:focus,.intro-section .wpcf7 .wpcf7-form-control.input-box:active,.intro-section .wpcf7 .wpcf7-form-control.textarea-box:focus,.intro-section .wpcf7 .wpcf7-form-control.textarea-box:active, .vertical-registration-form .selectize-input, .btn-primary',
