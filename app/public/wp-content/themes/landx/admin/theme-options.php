...
function landx_woo_ot_section(){
    
      return array(
          'id'          => 'woo_options',
          'title'       => __( 'Woo options', 'landx' )
        );
...
function landx_theme_options() {
  ...
  $custom_css = landx_custom_css();
   $woo_options = landx_woo_options();


  //merge all available options
  $settings = array_merge( $general_options, $background_options, $header_options, $sidebar_options, $footer_options,  $page_options, $blog_options, $typography_options, $styling_options, $theme_text, $custom_css, $woo_options );
